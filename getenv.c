...
/**
 * get_environ - our environment is copied as a string array
 ...
 *        constant_function prototype.
 *  Return: Delete yields 1, otherwise 0
 * @var: the env var string attribute
 */
...
/**
 * _setenv - Make a new contextual variable.
