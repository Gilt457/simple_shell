...
/**
 * list_to_strings - returns list->str strings.
 * @head: A link to the initial node
 *
...
/**
 * print_list - shows every item of a linked list of type list_t.
 * @h: A link to the initial node
 *
 * Return: List size
 */
...
/**
 * get_node_index - returns a node's index.
 * @head: list head pointer
 * @node: A link to the node
 *
