...
/**
 * check_chain - checks we should chain upon the previous status
 * @info: parameter structure
 * @buf: the character buffer
 * @p: current location in buf address
...
/**
 * replace_alias - in the tokenized string, inserts an alias
 * @info: parameter structure
 *
...
/**
 * replace_vars - vars in the tokenized string substituted
 * @info: parameter structure
 *
 * Return: If replaced, 1; else 0.
 */
